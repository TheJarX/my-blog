...
<img src="./img/image.png" alt="Code snippet" />
...
2. Add the configuration to `config/application.rb`:
   ...
   > BTW, I know that I wrote "surnName" lol

   📌 I recommend that you check the [github repo](https://github.com/vigetlabs/olive_branch) and this other [post](https://www.viget.com/articles/introducing-olivebranch/).
